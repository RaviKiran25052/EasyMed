                        ...
                        echo "<div class=\"row card m-3\" style=\"border: 0;\">";
                            echo "<div class=\"row g-0 m-4 bg-primary\">";
                                echo "<div class=\"col-sm-4\">";
                                    echo "<iframe src=\"" . htmlspecialchars($row[3]) . "\" style=\"border:0; height:100%; width:100%\" allowfullscreen=\"\" loading=\"lazy\" referrerpolicy=\"no-referrer-when-downgrade\"></iframe>";
                                    echo "</div>";
